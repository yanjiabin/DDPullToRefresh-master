...
public class ListViewWithFootViewActivity extends AppCompatActivity implements PageLimitDelegate.DataProvider {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view_with_foot_view);
